...
function Toast2(_a) {
  ...
  return /* @__PURE__ */ jsxs4(ToastPrimitive.Provider, { children: [
...
function Tooltip2(_a) {
  ...
  return /* @__PURE__ */ jsx6(TooltipPrimitive.Provider, { children: /* @__PURE__ */ jsxs5(TooltipPrimitive.Root, __spreadProps(__spreadValues({}, props), { children: [
